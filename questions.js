...
const QUESTION_BANK = [
  ...
  { id: 55, type: "mc", text: "What is the common keyboard shortcut used to undo a mistake in most design programs, including Tinkercad?", options: ["Ctrl+Z (Cmd+Z on Mac)", "Ctrl+P (Cmd+P on Mac)", "Ctrl+S (Cmd+S on Mac)", "Alt+F4 (Cmd+W on Mac)"], answer: 0 },
  ...
  { id: 57, type: "mc", text: "Which keyboard shortcut instantly duplicates the shape(s) you have selected?", options: ["Ctrl+D (Cmd+D on Mac)", "Ctrl+G (Cmd+G on Mac)", "Ctrl+A (Cmd+A on Mac)", "Ctrl+Z (Cmd+Z on Mac)"], answer: 0 },
  { id: 58, type: "mc", text: "Which keyboard shortcut groups two or more selected shapes together?", options: ["Ctrl+A (Cmd+A on Mac)", "Ctrl+G (Cmd+G on Mac)", "Ctrl+D (Cmd+D on Mac)", "Ctrl+C (Cmd+C on Mac)"], answer: 1 },
  ...
  { id: 60, type: "mc", text: "Which keyboard shortcut selects every shape in your current design at once?", options: ["Ctrl+A (Cmd+A on Mac)", "Ctrl+S (Cmd+S on Mac)", "Ctrl+O (Cmd+O on Mac)", "Ctrl+N (Cmd+N on Mac)"], answer: 0 },
  { id: 61, type: "tf", text: "After undoing a mistake with Ctrl+Z (Cmd+Z on Mac), you can press Ctrl+Shift+Z (Cmd+Shift+Z on Mac) to redo the action you just undid.", answer: true },
  { id: 62, type: "tf", text: "Locking a shape (for example with Ctrl+L, or Cmd+L on Mac) helps keep it from being accidentally moved or edited while you work on the rest of your design.", answer: true },
  ...
  { id: 93, type: "mc", text: "Which of these is NOT a way to select multiple shapes at once in Tinkercad?", options: ["Right-clicking a single shape twice", "Dragging a selection box around them", "Shift-clicking each shape", "Pressing Ctrl+A (Cmd+A on Mac) to select all"], answer: 0 },
